...
export {
  ...
  class self_aware_class : public mem::enable_strong_from_this<self_aware_class>
  {
  public:
    ...
    [[nodiscard]] mem::strong_ptr<self_aware_class> get_self()
    {
      return strong_from_this();
    }

    // Const version
    [[nodiscard]] mem::strong_ptr<self_aware_class const> get_self_const() const
    {
      return strong_from_this();
    }

    // Get weak reference
    mem::weak_ptr<self_aware_class> get_weak_self()
    {
  ...
  public:
    ...
    {
      return mem::make_strong_ptr<restricted_class>(alloc, p_value);
    }
  ...
  class fully_managed_class
    : public mem::enable_strong_from_this<fully_managed_class>
  {
  public:
    static auto create(std::pmr::memory_resource* alloc, int p_value)
    {
      return mem::make_strong_ptr<fully_managed_class>(alloc, p_value);
    }
    ...
    mem::strong_ptr<fully_managed_class> get_self()
    {
      return strong_from_this();
    }
